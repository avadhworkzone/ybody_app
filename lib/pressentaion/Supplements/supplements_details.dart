...
import '../DietFood/widgets/add_buttomcart.dart';
import '../DietFood/widgets/buttom_size.dart';
import '../GymDiscounts/widgets/openimagePriview.dart';
import '../GymDiscounts/widgets/sliderBig.dart';
import '../equilpemnet/screens/coupons_screen.dart';
import '../equilpemnet/widgets/cutomColorselect.dart';
import 'manager/detailed_supplement_cubit/detailed_supplement_cubit.dart';

class SupplementsDeteailsScreen extends StatefulWidget {
  const SupplementsDeteailsScreen({super.key});

  @override
  State<SupplementsDeteailsScreen> createState() =>
      _SupplementsDeteailsScreenState();
}


class _SupplementsDeteailsScreenState extends State<SupplementsDeteailsScreen> {
  int _selectedSize = 0;
  int _selectedColor = 0;
  @override
  Widget build(BuildContext context) {
    var wSize = MediaQuery.of(context).size.width;
    return BlocBuilder<DetailedSupplementCubit, DetailedSupplementState>(
      builder: (context, state) {
        if (state is DetailedSupplementSuccess) {
          DetailedProduct detailedSupplement = state.detailedProduct;
          List<String> imageUrls = [];
          List<String> sizes = [];
          List<String> colors = [];
          for (int i = 0; i < detailedSupplement.images!.length; i++) {
            imageUrls.add(detailedSupplement.images![i].image!);
          }
          for (int i = 0; i < detailedSupplement.sizes!.length; i++) {
            sizes.add(detailedSupplement.sizes![i].value!);
          }
          for (int i = 0; i < detailedSupplement.colors!.length; i++) {
            colors.add(detailedSupplement.colors![i].value!);
          }
          return Scaffold(
                    ...
                    child: Column(
                      ...
                      children: [
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      Text(
                                        '\$${detailedSupplement.price! - detailedSupplement.discount!}',
                                        style: TextStyle(
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      Text(
                                        '${((detailedSupplement.discount! / detailedSupplement.price!) * 100).floor()}%',
                                        style: TextStyle(
                                          color: MyColors.mainColor,
                                          fontSize: 24.sp,
                                          fontFamily:
                        ...
                        Padding(
                          ...
                          child: Text(detailedSupplement.descriptionEn!,
                              style: TextStyle(
                                color: MyColors.colorBlack,
                                fontSize: 12.sp,
                                fontFamily: (prefs.getString("lang") == "en")
        ...
        } else if (state is DetailedSupplementFailure) {
