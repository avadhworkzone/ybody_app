...
import 'package:x_fitness/pressentaion/GymDiscounts/widgets/openimagePriview.dart';
...
import 'manager/detailed_accessory_cubit/detailed_accessory_cubit.dart';

class AccessoriesDeatilsScreen extends StatefulWidget {
  const AccessoriesDeatilsScreen({super.key});

  @override
  State<AccessoriesDeatilsScreen> createState() => _MyWidgetState();
}

class _MyWidgetState extends State<AccessoriesDeatilsScreen> {
  int _selectedSize = 0;
  int _selectedColor = 0;
  @override
  Widget build(BuildContext context) {
    var wSize = MediaQuery.of(context).size.width;
    return BlocBuilder<DetailedAccessoryCubit, DetailedAccessoryState>(
      builder: (context, state) {
        if (state is DetailedAccessorySuccess) {
          DetailedProduct detailedAccessory = state.detailedAccessory;
          List<String> imageUrls = [];
          List<String> sizes = [];
          List<String> colors = [];
          for (int i = 0; i < detailedAccessory.images!.length; i++) {
            imageUrls.add(detailedAccessory.images![i].image!);
          }
          for (int i = 0; i < detailedAccessory.sizes!.length; i++) {
            sizes.add(detailedAccessory.sizes![i].value!);
          }
          for (int i = 0; i < detailedAccessory.colors!.length; i++) {
            colors.add(detailedAccessory.colors![i].value!);
          }
          return Scaffold(
                    ...
                    child: Column(
                      ...
                      children: [
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      Text(
                                        '\$${detailedAccessory.price! - detailedAccessory.discount!}',
                                        style: TextStyle(
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      Text(
                                        '${((detailedAccessory.discount! / detailedAccessory.price!) * 100).floor()}%',
                                        style: TextStyle(
                                          color: MyColors.mainColor,
                                          fontSize: 24.sp,
                                          fontFamily:
                        ...
                        Padding(
                          ...
                          child: Text(detailedAccessory.descriptionEn!,
                              style: TextStyle(
                                color: MyColors.colorBlack,
                                fontSize: 12.sp,
                                fontFamily: (prefs.getString("lang") == "en")
        ...
        } else if (state is DetailedAccessoryFailure) {
  ...
  Future<dynamic> showDialog2verifed() {
    return showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          content: Container(
            height: (prefs.getString("lang") == "en") ? 140.h : 160.h,
            width: 304.w,
            child: Column(
