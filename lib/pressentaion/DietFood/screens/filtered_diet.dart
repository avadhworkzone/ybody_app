...
class FilteredDietFood extends StatefulWidget {
  const FilteredDietFood({
    Key? key,
  }) : super(key: key);
  @override
  State<FilteredDietFood> createState() => _FilteredDietFoodState();
}

class _FilteredDietFoodState extends State<FilteredDietFood> {
  var _isFav;
  var isFav;
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: BlocBuilder<FilteredFoodsCubit, FilteredFoodsState>(
        builder: (context, state) {
          if (state is FilteredFoodsSuccess) {
                      ...
                      return GestureDetector(
                        child: Stack(
                          children: [
                            ...
                            GestureDetector(
                              onTap: () {
                                BlocProvider.of<DetailedDietFoodCubit>(context)
                                    .getDetailedDietFood(id: food.id!);
                                Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                        builder: (context) =>
          ...
          }  else if (state is FilteredFoodsFailure){
