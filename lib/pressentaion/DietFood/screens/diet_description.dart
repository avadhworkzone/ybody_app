...
import '../manager/detailed_diet_food_cubit/detailed_diet_food_cubit.dart';

class DietDescription extends StatefulWidget {
  const DietDescription({super.key});

  @override
  State<DietDescription> createState() => _MyWidgetState();
}

class _MyWidgetState extends State<DietDescription> {
  int _selectedSize = 0;
  int _selectedColor = 0;
  @override
  Widget build(BuildContext context) {
    var wSize = MediaQuery.of(context).size.width;
    return BlocBuilder<DetailedDietFoodCubit, DetailedDietFoodState>(
      builder: (context, state) {
        if (state is DetailedDietFoodSuccess) {
          DetailedProduct detailedFood = state.detailedProduct;
          List<String> imageUrls = [];
          List<String> sizes = [];
          List<String> colors = [];
          for (int i = 0; i < detailedFood.images!.length; i++) {
            imageUrls.add(detailedFood.images![i].image!);
          }
          for (int i = 0; i < detailedFood.sizes!.length; i++) {
            sizes.add(detailedFood.sizes![i].value!);
          }
          for (int i = 0; i < detailedFood.colors!.length; i++) {
            colors.add(detailedFood.colors![i].value!);
          }
          return Scaffold(
                    ...
                    child: Column(
                      ...
                      children: [
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      Text(
                                        '\$${detailedFood.price! - detailedFood.discount!}',
                                        style: TextStyle(
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      Text(
                                        '${((detailedFood.discount! / detailedFood.price!) * 100).floor()}%',
                                        style: TextStyle(
                                          color: MyColors.mainColor,
                                          fontSize: 24.sp,
                                          fontFamily:
                        ...
                        Padding(
                          ...
                          child: Text(detailedFood.descriptionEn!,
                              style: TextStyle(
                                color: MyColors.colorBlack,
                                fontSize: 12.sp,
                                fontFamily: (prefs.getString("lang") == "en")
        ...
        } else if (state is DetailedDietFoodFailure) {
