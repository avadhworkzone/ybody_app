...
import 'manager/filtered_sports_wear_cubit/filtered_sports_wear_cubit.dart';

class FilteredSportsWear extends StatefulWidget {
  const FilteredSportsWear({
    Key? key,
  }) : super(key: key);
  @override
  State<FilteredSportsWear> createState() => _FilteredSportsWearState();
}

class _FilteredSportsWearState extends State<FilteredSportsWear> {
  var _isFav;
  var isFav;
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: BlocBuilder<FilteredSportsWearCubit, FilteredSportsWearState>(
        builder: (context, state) {
          if (state is FilteredSportsWearSuccess) {
          ...
          }  else if (state is FilteredSportsWearFailure){
