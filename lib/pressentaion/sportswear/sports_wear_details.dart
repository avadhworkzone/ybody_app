...
import 'manager/detailed_sports_wear_cubit/detailed_sports_wear_cubit.dart';

class SportsWearDeatils extends StatefulWidget {
  const SportsWearDeatils({super.key});

  @override
  State<SportsWearDeatils> createState() => _MyWidgetState();
}

class _MyWidgetState extends State<SportsWearDeatils> {
  int _selectedSize = 0;
  int _selectedColor = 0;
  @override
  Widget build(BuildContext context) {
    var wSize = MediaQuery.of(context).size.width;
    return BlocBuilder<DetailedSportsWearCubit, DetailedSportsWearState>(
      builder: (context, state) {
        if (state is DetailedSportsWearSuccess) {
          DetailedProduct detailedSportsWear = state.detailedProduct;
          List<String> imageUrls = [];
          List<String> sizes = [];
          List<String> colors = [];
          for (int i = 0; i < detailedSportsWear.images!.length; i++) {
            imageUrls.add(detailedSportsWear.images![i].image!);
          }
          for (int i = 0; i < detailedSportsWear.sizes!.length; i++) {
            sizes.add(detailedSportsWear.sizes![i].value!);
          }
          for (int i = 0; i < detailedSportsWear.colors!.length; i++) {
            colors.add(detailedSportsWear.colors![i].value!);
          }
          return Scaffold(
                    ...
                    child: Column(
                      ...
                      children: [
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      Text(
                                        '\$${detailedSportsWear.price! - detailedSportsWear.discount!}',
                                        style: TextStyle(
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      Text(
                                        '${((detailedSportsWear.discount! / detailedSportsWear.price!) * 100).floor()}%',
                                        style: TextStyle(
                                          color: MyColors.mainColor,
                                          fontSize: 24.sp,
                                          fontFamily:
                        ...
                        Padding(
                          ...
                          child: Text(detailedSportsWear.descriptionEn!,
                              style: TextStyle(
                                color: MyColors.colorBlack,
                                fontSize: 12.sp,
                                fontFamily: (prefs.getString("lang") == "en")
        ...
        } else if (state is DetailedSportsWearFailure) {
