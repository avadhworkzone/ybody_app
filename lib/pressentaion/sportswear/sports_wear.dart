...
import 'filtered_wear.dart';
import 'manager/all_sports_wear_cubit/all_sports_wear_cubit.dart';
import 'manager/sports_wear_categories_cubit/sports_wear_categories_cubit.dart';

class SportsWearScreen extends StatefulWidget {
  const SportsWearScreen({super.key});

  @override
  State<SportsWearScreen> createState() => _SportsWearScreenState();
}

class _SportsWearScreenState extends State<SportsWearScreen> {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            CustomAppBar(
              text: translateString('Sports Wear', 'الملابس الرياضية', 'جلی وەرزشی'),
            ),
            Padding(
            ...
            SizedBox(
              ...
              child: BlocBuilder<SportsWearCategoriesCubit,
                  SportsWearCategoriesState>(
                builder: (context, state) {
                  if (state is SportsWearCategoriesSuccess) {
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return GestureDetector(
                            onTap: () {
                              BlocProvider.of<FilteredSportsWearCubit>(context).getSubCategoryData(id: subCategory.id!);
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (ctx) => const FilteredSportsWear()));
                            },
                            child: Padding(
                              padding: EdgeInsets.only(
                  ...
                  } else if (state is SportsWearCategoriesFailure) {
            ...
            BlocBuilder<AllSportsWearCubit, AllSportsWearState>(
              builder: (context, state) {
                if (state is AllSportsWearSuccess) {
                  List<Product> products = state.wears;
                      ...
                      return GestureDetector(
                        child: Stack(
                          children: [
                            ...
                            GestureDetector(
                              onTap: () {
                                BlocProvider.of<DetailedSportsWearCubit>(context).getDetailedSportsWear(id: product.id!);
                                Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                        builder: (context) =>
                ...
                } else if (state is AllSportsWearFailure) {
                  return CustomErrorScreen(errorMessage: state.errorMessage);
                } else {
                  return const CustomLoadingIndicator();
                }
