...
import 'EquipmentsDeatilScreen.dart';

class FilteredEquipment extends StatefulWidget {
  const FilteredEquipment({
    Key? key,
  }) : super(key: key);
  @override
  State<FilteredEquipment> createState() => _FilteredEquipmentState();
}

class _FilteredEquipmentState extends State<FilteredEquipment> {
  var _isFav;
  var isFav;
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: BlocBuilder<FilteredEquipmentsCubit, FilteredEquipmentsState>(
        builder: (context, state) {
          if (state is FilteredEquipmentsSuccess) {
                ...
                children: [
                  ...
                  GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      Product equipment = products[index];
                      return GestureDetector(
                        child: Stack(
                          children: [
                            ...
                            GestureDetector(
                              onTap: () {
                                BlocProvider.of<DetailedEquipmentCubit>(context)
                                    .getDetailedEquipment(id: equipment.id!);
                                Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                        builder: (context) =>
          ...
          }  else if (state is FilteredEquipmentsFailure){
